...
2. Clone this copy to your local disk:
        ...
        $ git clone https://github.com/YourLogin/system-design-primer.git
...
See the English contribution workflow above.
...
* Tag the relevant maintainer for a code review and keep the change scoped to the intended language.
...
* Do you have time to maintain a language? Document the scope and ownership in the contribution request.
* Check open issues and pull requests before starting overlapping work; offer to help with an existing effort when appropriate.
