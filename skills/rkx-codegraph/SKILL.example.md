...
- feature map across `server`, `frontend`, `messaging`, `admin-ui`
...
| Layer | Owner |
|-------|-------|
| Monorepo graph, routes, workers, cross-package trace | **codegraph** |
...
See [project-map.md](project-map.md). Key zones: `packages/server/src/routes/`, `workers/**/sync*`, `packages/frontend/src`, `packages/messaging/*`.

**Out of scope:** `x-old-projects/`, `user-export/`, `code-export/`, `tmp/`.
